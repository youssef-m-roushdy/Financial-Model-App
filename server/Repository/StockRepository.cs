...
namespace server.Repository
{
    public class StockRepository : IStockRepository
    {
        ...
        {
            var stocks = _context.Stock.Include(x => x.Comments).ThenInclude(y => y.AppUser).AsQueryable();
        ...
        {
            return await _context.Stock.Include(x => x.Comments).FirstOrDefaultAsync(y => y.Id == id);
        }
